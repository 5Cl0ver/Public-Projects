...
class Ui_MainWindow(object):
        def setupUi(self, MainWindow):
                ...
                self.background_IMG.setPixmap(QtGui.QPixmap("pkmn_imgs\Pkmn_ui_photo.jpg"))
                ...
                self.output_text.setObjectName("defending_text")
                self.output_text.setStyleSheet("border-image: url(pkmn_imgs/tes.jpg);color: rgb(85, 85, 255); font-size: 30px;")
                self.output_text.setPixmap(QtGui.QPixmap("pkmn_imgs/tes.jpg"))
